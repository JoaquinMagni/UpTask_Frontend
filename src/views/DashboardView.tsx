...
export default function DashboardView() {
  ...
  if(data && user) return (
    <>
      ...
      <nav className="my-5">
        <Link
          className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl font-bold uppercase cursor-pointer transition-colors"
          to="/projects/create"
        >Nuevo Proyecto</Link>
      </nav>
      ...
      {data.length ? (
        ...
        <p className="text-center py-20">No hay proyectos aún. {''}
          <Link
            to="/projects/create"
            className="text-fuchsia-500 font-bold uppercase"
          >Crear Proyecto</Link>
